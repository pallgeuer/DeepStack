...
# Configuration
export CFG_CUDA_VERSION=11.2
export CFG_CUDA_URL='https://developer.download.nvidia.com/compute/cuda/11.2.2/local_installers/cuda_11.2.2_460.32.03_linux.run'
